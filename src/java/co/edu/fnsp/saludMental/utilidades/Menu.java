...
public class Menu {
    ...
    public static String obtenerMenu(List<OpcionMenu> opcionesMenu) {
     ...
     */
    public static String obtenerOpcionesMenu(int nivel, int padre, List<OpcionMenu> opcionesMenu) {
